  ...
  return (
    <div className='space-y-6'>
      ...
      <section className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
        {/* Orders table (2/3) — client component handles tab filtering */}
        <DashboardOrdersTable orders={MOCK_ORDERS} />
      ...
      <section className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
        {/* Top products (2/3) — client component handles period selector */}
