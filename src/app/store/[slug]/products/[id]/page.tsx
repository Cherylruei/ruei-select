...
export default function ProductDetailPage() {
  ...
  return (
    <>
      ...
      {/* 主內容：手機單欄 / 桌面雙欄 */}
      <div className='pb-32 lg:pb-10 lg:flex lg:gap-8 lg:items-start lg:px-4'>
        {/* 圖片區（桌面 sticky） */}
        <div className='lg:w-[440px] lg:shrink-0 lg:sticky lg:top-[72px]'>
        ...
        {/* 商品資訊區 */}
        <div className='px-4 pt-4 flex flex-col gap-4 lg:flex-1 lg:px-0 lg:pt-0'>
          {/* 名稱、分類 */}
          <div>
            <h1
          ...
          {/* 桌面版內嵌 CTA */}
          <div className='hidden lg:block mt-2'>{orderButton}</div>
        </div>
      </div>

      {/* 手機版固定底部 CTA */}
      <div
        className='fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-[var(--neutral-200)] px-4 py-3 lg:hidden'
...
function ProductDetailSkeleton() {
  return (
    <div className='lg:flex lg:gap-8 lg:items-start lg:px-4'>
      <div className='aspect-square bg-[var(--neutral-100)] animate-pulse lg:w-[440px] lg:shrink-0' />
      <div className='px-4 pt-4 lg:px-0 lg:pt-0 lg:flex-1 flex flex-col gap-4'>
